...
每天发现适合普通用户的 Agent Skills。所有条目均保留原始来源、热度依据、使用门槛和权限提示。

> 数据由本地 Codex 采集与编辑，本仓库只承担公开发布、历史归档和社区投稿。
...
- 从今日榜单选择感兴趣的 Skill。
- 打开“原始 Skill”查看作者说明与安装步骤。
- 安装前检查账号、费用、文件访问和网络权限。
- “值得试用”不代表已经完成独立安全审计。

## 如何投稿

使用 [Skill 投稿 Issue](../../issues/new?template=submit-skill.yml) 推荐项目。投稿不会自动上榜，系统会检查来源、可安装性、普通用户适配度和权限披露。

## 数据

- [完整 Skill 数据](data/skills.json)
- [每日结构化榜单](data/daily/)
- [每日 Markdown 归档](pages/daily/)
- [收录与排名规则](RULES.md)

## 更新频率

候选数据按固定周期采集，正式榜单按北京时间每日发布。数据不足时宁可少发，也不会用无法验证的内容填满榜单。
