...
> **简介：** 当你想给 Agent 增加新能力时，它会理解需求、搜索开放 Skill 生态并给出候选与安装命令；使用时需要本地运行 npx skills。
...
> **简介：** 为 Paperclip 前端开发统一组件、颜色、排版、状态和布局规范，适合新增或修改界面时调用；必须与 frontend-design、web-design-guidelines 配合使用。
